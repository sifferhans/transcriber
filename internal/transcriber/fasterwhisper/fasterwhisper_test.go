...
// tests share them with internal/formats: a raw whisper-ctranslate2 JSON
// parsed by this package must, after round-tripping through formats.Write,
// produce byte-identical output to those goldens.
